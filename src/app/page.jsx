          ...
          <section className='flex gap-5 justify-center flex-wrap'>
            <div className='p-5 w-full md:w-7/16 rounded-(--border-radius)' style={{ background: "var(--fill-gradient)" }}>
              ...
              <div className='mt-2 mx-0.5 flex justify-between items-center'>
                ...
                <a href="" target='_blank' className=' flex justify-center gap-1.5 border border-(--stoke-color) rounded-(--border-radius) text-(--primary-text) text-[12px] sm:text-[15px] md:text-[12px] lg:text-[15px] px-2 py-1  cursor-pointer z-10' style={{ background: "var(--fill-gradient)" }}>
                  <p >See My Work</p>
