...
export default function NavBar() {
  ...
  return (
    <section
      className="fixed -top-5 left-1/2 z-20 -translate-x-1/2 mx-auto mt-11 w-[85%] sm:w-[495px] h-[66px] rounded-(--border-radius) border border-(--stoke-color) py-5 px-3 sm:px-6 backdrop-blur-sm"
