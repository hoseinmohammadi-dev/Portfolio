...
export default function Footer() {
  ...
  return (
    <section id='contact' className='flex flex-col items-center relative z-0 h-80 w-full bg-[url("/image/grid-pattern.svg")] bg-cover bg-no-repeat'>
      ...
      <a href="https://wa.me/989180888233" target='_blank' className='scroll-title w-[250px] flex justify-center gap-2.5 border border-(--stoke-color) rounded-(--border-radius) text-(--primary-text) text-[12px] sm:text-[16px] px-7 py-3 mt-4 cursor-pointer z-10'
