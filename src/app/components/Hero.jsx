...
export default function Hero() {
    return (
        <section id='hero' className='mt-30 flex flex-col items-center'>
            <h1 className='text-[30px] sm:text-[45px] md:text-[60px] text-center text-(--primary-text) font-bold z-10'>Hey, I'm <br className='lg:hidden' /><strong className='text-(--title-text)'>Hosein Mohammadi</strong><br /> Frontend Developer</h1>
